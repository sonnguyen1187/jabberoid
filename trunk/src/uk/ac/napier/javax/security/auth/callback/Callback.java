 ...
 *
 * @see uk.ac.napier.javax.security.auth.callback.CallbackHandler
 * @see uk.ac.napier.javax.security.auth.callback.ChoiceCallback
 * @see uk.ac.napier.javax.security.auth.callback.ConfirmationCallback
 * @see uk.ac.napier.javax.security.auth.callback.LanguageCallback
 * @see uk.ac.napier.javax.security.auth.callback.NameCallback
 * @see uk.ac.napier.javax.security.auth.callback.PasswordCallback
 * @see uk.ac.napier.javax.security.auth.callback.TextInputCallback
 * @see uk.ac.napier.javax.security.auth.callback.TextOutputCallback
 */
